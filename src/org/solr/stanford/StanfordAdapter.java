...
public class StanfordAdapter implements Iterator<String> {
  ...
  private StanfordAdapter(Reader input, String modelDir) {
    ...
    props.setProperty("serDictionary", modelDir + "/dict-chris6.ser.gz" + ","
        + modelDir + "/dict-chris6.ser.gz");
  ...
  public synchronized static StanfordAdapter getInstance(Reader input,
      String modelDir) {
    if (null == adapter) {
